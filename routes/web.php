...
Route::group(['middleware' => 'auth'], function () {
    ...
    //ALL SUGGESTED USERS
    Route::get('/suggested-users', [HomeController::class, 'showSuggestedUsers'])->name('user.suggested');
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::delete('/admin/posts/{id}/delete', [PostsController::class, 'hide'])->name('admin.posts.hide');

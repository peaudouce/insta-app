<div class="modal fade" id="likes-modal{{ $post->id }}">
    <div class="modal-dialog">
        <div class="modal-content border-primary">
            <div class="modal-header border-0">
                <button data-bs-dismiss="modal" class="btn btn-sm ms-auto text-primary fw-bold"><i class="fa-solid fa-xmark"></i></button>
            </div>

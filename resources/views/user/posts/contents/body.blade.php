<div class="row align-item-center">
    ...
    <div class="col-auto px-0">
        ...
        @if($post->likes->count() > 0)
            {{-- <a href="" class="text-decoration-none text-dark" data-bs-toggle="modal" data-bs-target="#likes-modal{{ $post->id }}">{{ $post->likes->count() }}</a> --}}
            <button class="btn p-0" data-bs-toggle="modal" data-bs-target="#likes-modal{{ $post->id }}">
                {{ $post->likes->count() }}
            </button>
